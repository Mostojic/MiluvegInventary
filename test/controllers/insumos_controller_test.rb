...
class InsumosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insumo" do
    assert_difference('Insumo.count') do
      post insumos_url, params: { insumo: { Medida_id: @insumo.Medida_id, nombre: @insumo.nombre, precio: @insumo.precio } }
    end
  ...
  test "should update insumo" do
    patch insumo_url(@insumo), params: { insumo: { Medida_id: @insumo.Medida_id, nombre: @insumo.nombre, precio: @insumo.precio } }
